#!/usr/bin/env python3
"""
ailabel_gemini.py — Gemini API を使ったAIlabelアノテーションツール

使い方:
  python ailabel/ailabel_gemini.py --subset docs/design/AIlabel_subset_30.md --corpus corpus --out ailabel/results_gemini.csv
  python ailabel/ailabel_gemini.py --subset docs/design/AIlabel_subset_30.md --corpus corpus --out ailabel/results_gemini.csv --model gemini-1.5-pro
...
# ailabel_claude.pyと共通のプロンプト・ユーティリティを使用
...
def main():
    parser = argparse.ArgumentParser(description="AIlabel annotator using Gemini API")
